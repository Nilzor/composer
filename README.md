...
* `--device-aliases`
  * List of comma separated key-value pairs of device ID aliases. Will replace the Android Device IDs in the suite list (but not in report details). 
  * Example: `--device-aliases "123QR=SamsungS10,345AF=SamsungS20"`
* `--install-timeout`
